...
function BlogsPage() {
  ...
  return (
    <>
      ...
      <main>
        <p>
          Mostly a place for more didactic/polemical, one-and-done essays.{" "}
          <br />
          For less didactic/polemical, continuously-updated posts see{" "}
        ...
        <ul className="blogs-list">
          ...
          <ul>
            ...
            {/* <ul>
              <li>
                Art can be great by being inventive or by being perfective.
          ...
          <li className="blogs-list__month">November 2023</li>
          <ul>
            <li>
