...
function NotePaperNotesPage() {
  ...
  return (
    <MathJaxContext>
      ...
      <main>
        <MetaBox>
            <p><b>Key:</b> Target quotations/paraphrases/claims; <span style={{ color:myPurple}}>additional context/connections</span>; <span style={{ color: myGreen }}>my comments/thoughts/ideas</span>; <span style={{ color: myRed }}>my confusions/questions/todos</span>; <span style={{ color: myBlue }}>references to check out</span>; ... </p>
        </MetaBox>
        <PaperNote
        date="24-10-2023"
          authors="Häusser"
        ...
        >
          <ul>
            ...
            <li style={{color:myRed}}>This is an example confusion/question.</li>
            <li style={{color:myPurple}}>This is some additional context to remember.</li>
            <li style={{color:myBlue}}>This is a refernece to check: Author et al. (Journal, 2023).</li>
            <li style={{color:myGreen}}>This is an example comment/thought.</li>
          </ul>
        </PaperNote>
        <PaperNote
          authors="Joe et al."
