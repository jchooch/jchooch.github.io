  ...
  return (
    <>
      ...
      <main>
        ...
        <br />
        <h2>Other Channels I Recommend</h2>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            <b>New Wave Jiu Jitsu: A New Philosophy of Positional Escapes</b>{" "}
          ...
          <li>
            ...
            <span style={{ color: "red" }}>[LINK]</span> | Lachlan Giles
          </li>
          <li>
            ...
            <span style={{ color: "red" }}>[LINK]</span> | Craig Jones
          </li>
          <li>
            <b>
              ...
              <span style={{ color: "red" }}>[LINK]</span>, 2.0{" "}
              <a href="">
                <img style={bjjfIconStyle} src={bjjFanaticsIcon} />
              </a>{" "}
